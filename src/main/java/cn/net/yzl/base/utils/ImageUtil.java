...
public class ImageUtil {
     ...
     * @return
     */
    public static Bitmap drawTextToLeftTop(Context context, Bitmap bitmap, String text, float size, int color, int paddingLeft, int paddingTop) {
    ...
    private static Bitmap drawTextToBitmap(Context context, Bitmap bitmap, String text, TextPaint paint, Rect bounds, int paddingLeft, int paddingTop) {
        ...
        StaticLayout layout = new StaticLayout(text, 0, text.length(), paint, (int) (bitmapWidth - textSize),
...
//        canvas.drawText(text, paddingLeft, paddingTop, paint);
     ...
     * @param bitmap Bitmap
     */
    public static void saveWaterBitmap(Bitmap bitmap,String path) {
        String savePath;
        File filePic;
