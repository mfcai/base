...
public final class SPUtils {
    ...
    private SPUtils(final String spName) {
        sp = AppConfig.getApp().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }
    ...
    public void saveLoginInfo(LoginInfo loginInfo) {
        ...
        put(Constant.SP_LOGIN_INFO, new Gson().toJson(loginInfo));
    }
    /*
     *loginInfo缓存在EctUserInfoSp.getInstance()中，这部分代码用于提供对外部接口，使用中需要注意
     */
    public LoginInfo getLoginInfo() {
        String loginInfoStr = getString(Constant.SP_LOGIN_INFO);
        if ("".equals(loginInfoStr)) {
            return null;
        }
        //Log.e("TGA",loginInfoStr);
        LoginInfo loginInfo = new Gson().fromJson(loginInfoStr, LoginInfo.class);
        return loginInfo;
    }
}
