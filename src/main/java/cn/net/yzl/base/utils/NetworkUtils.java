...
import cn.net.yzl.base.utils.ShellUtils;
...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        AppConfig.getApp().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS)
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager manager =
                (ConnectivityManager) AppConfig.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) AppConfig.getApp().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) AppConfig.getApp().getSystemService(Context.WIFI_SERVICE);
