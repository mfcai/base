...
public class NumberProgressBar extends View {
    ...
    public NumberProgressBar(Context context, AttributeSet attrs,
        ...
        mReachedBarColor = attributes.getColor(
                R.styleable.NumberProgressBar_loan_progress_reached_color,
                default_reached_color);
        mUnreachedBarColor = attributes.getColor(
                R.styleable.NumberProgressBar_loan_progress_unreached_color,
                default_unreached_color);
        mTextColor = attributes.getColor(
                R.styleable.NumberProgressBar_loan_progress_text_color,
                default_text_color);
        mTextSize = attributes.getDimension(
                R.styleable.NumberProgressBar_loan_progress_text_size,
                default_text_size);

        mReachedBarHeight = attributes.getDimension(
                R.styleable.NumberProgressBar_loan_progress_reached_bar_height,
                default_reached_bar_height);
        mUnreachedBarHeight = attributes.getDimension(
                R.styleable.NumberProgressBar_loan_progress_unreached_bar_height,
                default_unreached_bar_height);
        mOffset = attributes.getDimension(
                R.styleable.NumberProgressBar_loan_progress_text_offset,
                default_progress_text_offset);

        int textVisible = attributes.getInt(
                R.styleable.NumberProgressBar_loan_progress_txt_visibility,
        ...
        setProgress(attributes
                .getInt(R.styleable.NumberProgressBar_loan_progress, 0));
        setMax(attributes.getInt(R.styleable.NumberProgressBar_loan_max, 100));
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        try{
            ...
            Log.e("NumberProgressBar",ex.toString());
        }
        state = null;
    }
