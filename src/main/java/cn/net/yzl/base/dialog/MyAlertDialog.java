...
import cn.net.yzl.base.dialog.AlertController;
...
public class MyAlertDialog extends Dialog {
    ...
    public static class Builder {
        ...
        //宽高自适应
        public Builder setAutoAdapter(){
            P.isSelfAdaption = true;
            return this;
        }
         ...
         * @return
         */
        public Builder setAutoWidthAndHeight(int width, int height){
            P.mWidth = width;
            P.mHeight = height;
            return this;
        }
